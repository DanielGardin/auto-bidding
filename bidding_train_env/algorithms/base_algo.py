        ...
        for epoch in range(1, num_epochs + 1):
            ...
            for step in pbar:
                ...
                for key, value in train_info.items():
                    epoch_info[key] += value / steps_per_epoch

                self.global_step += 1

            pbar.set_postfix(epoch_info)
            ...
            for period in val_periods:
                ...
                for key, value in eval_info.items():
                    eval_total[key] += value / len(val_periods)

            write_info(f"eval", eval_total)
